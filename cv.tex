...
\begin{itemize}[leftmargin=0em, noitemsep, nolistsep]
    ...
    \item[] \large\textbf{Hong Kong Baptist University} \hfill Hong Kong
        \begin{itemize}[noitemsep, nolistsep, leftmargin=0em]
            \item[] {Research Assistant} \hfill 2020.10-2021.11
             \begin{itemize}
                \small
...
\begin{itemize}[leftmargin=0em, noitemsep, nolistsep]
    \setlength\itemsep{1em}
    \item[] \large\textbf{Hex Trust} \hfill Remote/Hong Kong
    \begin{itemize}[noitemsep, nolistsep, leftmargin=0em]
        \item[] {Developer} \hfill 2022.04-PRESENT
         \begin{itemize}
            \small
    ...
    \item[] \large\textbf{The Linux Foundation} \hfill Remote
        \begin{itemize}[noitemsep, nolistsep, leftmargin=0em]
            \item[] Software Development Engineer (Blockchain) Internship\hfill 2020.06-2020.12
            \begin{itemize}
                \small
    ...
    \item[] \large\textbf{Hyperledger} \hfill Remote
        \begin{itemize}[noitemsep, nolistsep, leftmargin=0em]
            \item[] Mentor \hfill 2021.03-2021.11
            \begin{itemize}
                \small
            ...
            \end{itemize}
            \item[] Mentor \hfill 2020.03-2020.11
            \begin{itemize}
                \small
...
\begin{itemize}
    ...
    \item[2020] \bibentry{xu2020lightweight}
\end{itemize}
